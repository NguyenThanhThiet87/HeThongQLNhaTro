...
import { updateNguoiThueApi } from '../../../api/NguoiDung';
import { useEditNtProfile } from '../../../hooks/user/useUserProfile';
...
const ThayDoiThongTinCaNhan = ({ route }) => {
    ...
    const [ngheNghiepError, setNgheNghiepError] = useState('');
    const [hoTenNguoiThanError, setHoTenNguoiThanError] = useState('');
    const [soDienThoaiNguoiThanError, setSoDienThoaiNguoiThanError] = useState('');
    const [quanHeVoiNguoiThanError, setQuanHeVoiNguoiThanError] = useState('');
    ...
    } = useEditNtProfile(route.params.maNd, navigation);
                    ...
                    <View style={styles.form}>
                        ...
                        <View style={styles.boxNguoiLienHe}>
                            <View style={styles.headerNguoiLienHe}>
                                ...
                                <Text style={styles.titleNguoiLienHe}>Liên hệ khẩn cấp</Text>
                            </View>
                            <InputGroup
                                label="Họ tên"
                                value={hoTenNguoiThan}
                                onChangeText={setHoTenNguoiThan}
                                placeholder="Nhập họ tên..."
                                iconName="person"
                            />
                            <InputGroup
                                label="Số điện thoại"
                                value={soDienThoaiNguoiThan}
                                onChangeText={setSoDienThoaiNguoiThan}
                                placeholder="Nhập số điện thoại..."
                                iconName="phone"
                            />
                            <InputGroup
                                label="Mối quan hệ"
                                value={quanHeVoiNguoiThan}
                                onChangeText={setQuanHeVoiNguoiThan}
