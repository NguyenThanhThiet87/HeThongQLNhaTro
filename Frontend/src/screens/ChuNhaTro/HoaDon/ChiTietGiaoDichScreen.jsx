...
Cảm ơn quý khách!
    ...
    const handleShareTransaction = async () => {
        handleDownloadReceipt(); // Sử dụng cùng logic share cho đơn giản
    };
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.content}>
                ...
                <View style={styles.amountContainer}>
                    <Text style={styles.amountValue}>{transactionDetails ? formatCurrency(transactionDetails.soTien) : '0đ'}</Text>
                </View>
                ...
                <View style={styles.detailsWrapper}>
                    <InfoSection title="THÔNG TIN HÓA ĐƠN">
                        ...
                        <DetailRow label={"Ghi chú"} value={transactionDetails ? transactionDetails.ghiChu : 'N/A'} />
                    </InfoSection>

                    <InfoSection title="CHI TIẾT THANH TOÁN">
                        <DetailRow label="Phương thức" value={transactionDetails ? transactionDetails.phuongThuc : 'N/A'} />
