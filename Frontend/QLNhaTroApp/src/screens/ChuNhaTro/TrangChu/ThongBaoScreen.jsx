...
export default function ThongBaoScreen({ navigation }) {
    ...
    const handlePressNotification = async (item) => {
        ...
        if (item.loaiTb == "HoaDon") {
            navigation.navigate("Bill", { screen: "ChiTietGiaoDich", params: { maLstt: item.maThucThe } });
        } else {
            navigation.navigate("ChiTietBaoCaoSuCo", { maBasc: item.maThucThe });
        }
    };
