...
const HoSo = ({ route }) => {
    ...
    console.log("Mã người thuê:", maNd);
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <AppHeader
                ...
                center={
                    <Text style={[styles.headerTitle, { color: COLORS.textMain }]}>Hồ sơ người thuê</Text>
                }
                right={
                ...
                <View style={styles.profileSection}>
                    <View style={styles.avatarContainer}>
                        <View style={styles.avatarRing}>
                            <Image
                                source={{ uri: nguoiThue?.avatar || "https://i.pravatar.cc/300" }}
                                style={styles.avatar}
                            />
                        </View>
