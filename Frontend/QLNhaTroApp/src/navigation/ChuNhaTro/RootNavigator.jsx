...
import useSignalR from "../../hooks/ChatHub/useSignalR";

import BottomTabNavigatorOwner from "./BottomTabNavigatorOwner";
import BottomTabNavigatorTenant from "../NguoiThueTro/BottomTabNavigatorTenant";
import BottomTabNavigatorProvider from "../NguoiCungCap/BottomTabNavigatorProvider";
...
export default function RootNavigator() {
  ...
  const getMainNavigator = () => {
    ...
    switch (user?.maVaiTro) {
      ...
      case ROLES.NHA_CUNG_CAP:
        return BottomTabNavigatorProvider;
      default:
        return BottomTabNavigatorTenant;
    }
  };
