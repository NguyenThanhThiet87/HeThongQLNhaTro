...
export default function TaoHopDongB1Screen() {
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.service}>
                        ...
                        <View style={styles.rowBetween}>
                            ...
                            <View style={styles.row}>
                                ...
                                <View style={[styles.serviceIcon, { backgroundColor: "rgba(168,85,247,0.15)" }]}>
                                    <MaterialIcons name="wifi" size={20} color="#a855f7" />
                                </View>

                                <View>
                                    <Text style={styles.serviceTitle}>Internet</Text>
                                    <Text style={styles.serviceSub}>Phí cố định</Text>
                                </View>
                            ...
                            <Switch
                                ...
                                thumbColor="#fff"
                                trackColor={{ true: PRIMARY, false: "#64748b" }}
                            />
                        ...
                        <View style={[
                            ...
                            <Text style={styles.unit}>đ/phòng</Text>
